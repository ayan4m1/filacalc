    ...
    <FormPage
      calculate={useCallback((vals) => {
        ...
        if (!evenlyDivisible) {
          ...
          let error =
            heightMultiple / stepHeight -
            Math.floor(heightMultiple / stepHeight);
      ...
      description="Use this calculator to calibrate your layer heights based on your Z-axis

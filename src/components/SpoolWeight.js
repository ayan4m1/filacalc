...
export default function SpoolWeight() {
  ...
  return (
    <FormPage
      ...
      description="Use this calculator to determine the amount of filament remaining on a
        partially used spool. Enter the current net weight and the spool weight and the calculator will determine the amount of remaining filament."
      initialValues={{
        brand: '',
        material: '',
        filamentDiameter,
      ...
      renderForm={({ values, handleBlur, handleChange }) => (
        <Form>
          <Form.Group>
